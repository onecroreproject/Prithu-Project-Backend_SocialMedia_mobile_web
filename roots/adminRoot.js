...
/* --------------------- Admin Post Global Options API --------------------- */
const postGlobalOptionController = require('../controllers/adminControllers/postGlobalOptionController');
router.get('/admin/post-global-options', postGlobalOptionController.getPostGlobalOptions);
router.post('/admin/post-global-options/week-gods', postGlobalOptionController.addWeekGod);
router.put('/admin/post-global-options/week-gods/:id', postGlobalOptionController.updateWeekGod);
router.delete('/admin/post-global-options/week-gods/:id', postGlobalOptionController.deleteWeekGod);
router.post('/admin/post-global-options/special-days', postGlobalOptionController.addSpecialDay);
router.put('/admin/post-global-options/special-days/:id', postGlobalOptionController.updateSpecialDay);
router.delete('/admin/post-global-options/special-days/:id', postGlobalOptionController.deleteSpecialDay);
router.put('/admin/post-global-options/sessions', postGlobalOptionController.updateSessions);
router.put('/admin/post-global-options/days', postGlobalOptionController.updateDays);
